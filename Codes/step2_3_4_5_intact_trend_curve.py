...
## Figure for step 2 - intact
## Figure for step 3 - trends
test = figstwo_record_outage_intact_trends(Dict_All, wm_name, 'All Device')
...
# If needing overlay of multiple curves, keep the initial figure open
cdf_oneline_colordefault(edges, fp_cum, 'All Devices', binnum, wm_name)
