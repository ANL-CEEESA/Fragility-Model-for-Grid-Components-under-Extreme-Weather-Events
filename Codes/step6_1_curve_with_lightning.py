...
COMED_HILP_Derecho_clean = COMED_HILP_Derecho_clean[COMED_HILP_Derecho_clean['Lightning'] == 1]
...
test = figstwo_record_outage_intact_trends(Dict_All, wm_name, 'All Device - with lightning')
...
cdf_oneline_colordefault(edges, fp_cum, 'All Devices - with lightning', binnum, wm_name)
